...
# CUDA_VISIBLE_DEVICES=0,1 timeout 12h vllm serve "$MODEL_ID" --pipeline_parallel_size 2 --max-model-len 1200 --gpu-memory-utilization 0.8 # qwen 72b
...
CUDA_VISIBLE_DEVICES=0,1,2,3 timeout 12h vllm serve "$MODEL_ID" --tensor-parallel-size 4 --max-model-len 1200 --gpu-memory-utilization 0.8 # llama 4 scout 17b
