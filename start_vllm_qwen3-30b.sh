...
VLLM_ENABLE_V1_MULTIPROCESSING=0 CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 "$VENV/bin/vllm" serve Qwen/Qwen3-30B-A3B-Instruct-2507 \
    --tensor-parallel 8 --gpu-memory-utilization 0.9 \
